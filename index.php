    ...
    <section>
        <div class="container-fluid mt-5">
            <div class="row banner ml-5 mt-5">
                <div class="col-7 marge mt-5">
                    <h1 class="">Université <span class="banner-media">E-media</span></h1>
                    <h4>Visons haut et loin</h4>
                    <p class="col-10 banner-text ml-1">Notre vision c’est de bâtir l’Afrique de demain, donner à tout et en chacun une formation Universitaire de haut niveau mais à moindre cout, et avec plusieurs spécialisations au choix.</p>
                    <div class="mt-4">
                        <button type="button" class="btn btn-info">Contact</button>
                        <button type="button" class="btn ml-2 btn-outline-info">Se connecter</button>
                    </div>
                    <div class="social mt-4 p-2" align="center">
                        <a href=""><i class="fab fa-facebook-square"></i></a>
                        <a href="" class="ml-2"><i class="fab fa-linkedin"></i></a>
                        <a href="" class="ml-2"><i class="fab fa-twitter-square"></i></a>    
                    </div>
                </div>
                <div class="col-5 test mb-2">
        ...
        <div class="row apropos mt-3 ml-5">
            ...
            <div class="col-8 apropos-right">
                ...
                <div class="row">
                    ...
                    <div class="col-6 mt-5 aos-init aos-animate code code--small code--left" data-aos="fade-up-left" data-aos-duration="2000">
                        <img src="img/accueil/apropos1.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="col-6 ml-5 aos-init aos-animate code code--small code--right" data-aos="fade-up-right" data-aos-duration="2000">
                        <img src="img/accueil/apropos1.jpg" alt="" class="img-fluid oui ml-5">
                    </div>
                </div>
            </div>
        </div>
